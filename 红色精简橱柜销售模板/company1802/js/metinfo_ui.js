...
function SetHome(obj,vrl,info){
	...
	try{
		obj.style.behavior='url({ms:globalskin.url/}#default#homepage)';obj.setHomePage(vrl);
	}catch(e){
		if(window.netscape){
			try{
